<?php
	...
	if ($rowdep['sum_gold'] <= 4999) {
		$_SESSION['msgb'] = 'Для участия в битвах нужно пополнить баланс минимум на 5 долларов!';
		header('Location: battles.php');
		exit();
	}
	...
	if ($checks1['status'] != 0) {
		$_SESSION['msgb'] = 'Извините, битва уже началась!';
		header('Location: battles.php');
		exit();
	}
	...
	if ($row2['silver'] < $checks1['battle_cost']) {
		$_SESSION['msgb'] = 'У вас недостаточно серебра.';
		header('Location: battles.php');
		exit();
	}
		...
		<div class="main">
			...
			<div class="battles_main">
				<div class="battles_buttons">
					<div class="battles_button3">Создать Битву</div>
				</div>
