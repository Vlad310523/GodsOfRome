			...
			<div class="main-reg">
				<div class="block-reg">
					...
					<div class="block-reg-container">
						<div class="form-reg">
							<div class="reg">
								<h1 class="msg-t">Бонус Pear tree при регистрации!</h1>
								<h1 class="h-reg"><a href="#" class="but1" style="cursor: default;">Регистрация</a> | <a href="login.php" class="but1 blur">Войти</a></h1>
								...
								<form class="form-main form-register" action="/inc/register.php" method="POST">
									...
									<label class="checkbox">
										...
										Я принимаю <a href="terms.php">Условия и положения</a>
									</label>
