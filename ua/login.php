			...
			<div class="main-reg">
				<div class="block-reg">
					...
					<div class="block-reg-container">
						<div class="form-reg">
							<div class="reg">
								<h1 class="h-reg"><a href="register.php" class="but1 blur">Реєстрація</a> | <a href="#" class="but1" style="cursor: default;">Увійти</a></h1>
								...
								<form class="form-main" action="/inc/login.php" method="POST">
									...
									<a class="form-text-forgot" href="forgot.php">Забули пароль?</a>
									<input class="reg-submit" type="submit" name="login" value="Увійти">
								</form>
							</div>
						</div>
					</div>
