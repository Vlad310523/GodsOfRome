		...
		<div class="main">
			...
			<dialog class="dialog_tutor">
				<div class="tutor_body">
					<div class="tutor_block">
						...
						<div class="block_text">Загалом на вашому острові п'ять посадкових грядок. На кожній з них ви можете посадити по одному дереву. Тому правильно розрахуйте посадки, щоб потім не довелося позбуватися дешевих дерев.</div>
					</div>
					<div class="tutor_block">
						<div class="block_text">Існує п'ять видів дерев, що відрізняються один від одного цінністю і плодючістю. У кожного дерева свій період збору врожаю; якщо не зібрати плоди протягом 24 годин після дозрівання, вони згниють, і вам доведеться вирощувати врожай заново.</div>
					...
					<div class="tutor_block">
						...
						<div class="block_text">Це місце зберігання, де зберігаються всі зібрані фрукти. Місткість сховища не обмежена.</div>
					</div>
					<div class="tutor_block">
						<div class="block_text">На острові також є торговець, у якого ви можете обміняти всі зібрані фрукти на срібло за курсом 1 фрукт за 1 срібло.</div>
							...
							<div class="itcss__items">
								<div class="itcss__item">
									...
									<div class="dialog_block2">
										<div class="block2"><div class="block2_text">Час збору: </div><div class="block2_amount">3 години</div></div>
										<div class="block2"><div class="block2_text">Кількість фруктів: </div><div class="block2_amount">3</div></div>
									</div>
									<form class="dialog_form" action="../../inc/buy_tree.php" method="POST">
										...
										<input class="dialog_yes" type="submit" name="buy" value="Купити">
									</form>
								</div>
								<div class="itcss__item">
									<div class="dialog_block1">
									...
									<div class="dialog_block2">
										<div class="block2"><div class="block2_text">Час збору: </div><div class="block2_amount">6 годин</div></div>
										<div class="block2"><div class="block2_text">Кількість фруктів: </div><div class="block2_amount">12</div></div>
									</div>
									<form class="dialog_form" action="../../inc/buy_tree.php" method="POST">
								...
								<div class="itcss__item">
									...
									<div class="dialog_block2">
										<div class="block2"><div class="block2_text">Час збору: </div><div class="block2_amount">12 годин</div></div>
										<div class="block2"><div class="block2_text">Кількість фруктів: </div><div class="block2_amount">48</div></div>
									</div>
									<form class="dialog_form" action="../../inc/buy_tree.php" method="POST">
								...
								<div class="itcss__item">
									...
									<div class="dialog_block2">
										<div class="block2"><div class="block2_text">Час збору: </div><div class="block2_amount">24 години</div></div>
										<div class="block2"><div class="block2_text">Кількість фруктів: </div><div class="block2_amount">240</div></div>
									</div>
									<form class="dialog_form" action="../../inc/buy_tree.php" method="POST">
								...
								<div class="itcss__item">
									...
									<div class="dialog_block2">
										<div class="block2"><div class="block2_text">Час збору: </div><div class="block2_amount">48 годин</div></div>
										<div class="block2"><div class="block2_text">Кількість фруктів: </div><div class="block2_amount">960</div></div>
									</div>
									<form class="dialog_form" action="../../inc/buy_tree.php" method="POST">
			...
			?>
				<dialog class="dialog_sell">
					<h2 class="dialog_sell_h2">Продати дерево?</h2>
					<h3 class="dialog_sell_h3">Ви отримаєте: <?=$tree_cost?> срібла</h3>
					<form class="dialog_sell_form" action="../../inc/collect_tree.php" method="POST">
						<input type="hidden" name="tree_id" value="<?=$tree_id?>">
						<input class="dialog_sell_yes" type="submit" name="sell" value="Так">
						<input class="dialog_sell_no" type="submit" name="dia_no" value="Ні" id="closesellwindow">
					</form>
				</dialog>
			<? } ?>
			...
			<dialog class="dialog_tree">
				...
				<div class="dialog_block2">
					<div class="block2"><div class="block2_text">Час збору: </div><div class="block2_amount"><?=$tree_time?></div></div>
					<div class="block2"><div class="block2_text">Кількість фруктів: </div><div class="block2_amount"><?=$tree_amount?></div></div>
				</div>
				<div class="dialog_tree_form">
					<form action="" method="POST">
						<input type="hidden" name="tree_id" value="<?=$_SESSION['tree2']?>">
						<input class="dialog_tree_sell" type="submit" name="sell" value="Продати">
					</form>
			...
			<dialog class="dialog_storage none">
				...
				<h2 class="dialog_storage_h2">Сховище</h2>
			...
			<dialog class="dialog_trader <?if(!isset($_SESSION['msgitf']) && !isset($_SESSION['msgit'])) { echo 'none'; } ?>">
				...
				<h2 class="dialog_trader_h2">Торговець</h2>
				...
				<h3 class="dialog_trader_h3">1 фрукт - 1 срібло</h3>
				...
				<form class="dialog_trader_form" action="../../inc/sell_fruits.php" method="POST">
					<h3 class="dialog_trader_h3">Ви отримаєте - <?=$storage['fruit1']+$storage['fruit2']+$storage['fruit3']+$storage['fruit4']+$storage['fruit5']?> срібла</h3>
					<input class="dialog_trader_yes" type="submit" name="sell" value="Продати все">
				</form>
			</dialog>
							...
							<div class="island_tree">
								<?if($tree['tree1'] !== '0') {?>
									<form class="island_tree_top island_tree<?=$tree['tree1']?><?if(time() >= $tree['tree1_time'] && time() < $tree['tree1_time'] + 86400) { echo '_ripe'; }?><?if(time() >= $tree['tree1_time'] + 86400) { echo '_rotten'; }?>" action="#" method="POST">
										<div class="tree_timer tree2_timer<?if(time() < $tree['tree1_time']) { echo ' none'; }?><?if(time() >= $tree['tree1_time'] + 86400) { echo ' time_rotten'; }?>"><?if(time() >= $tree['tree1_time'] + 86400) { echo 'Згнило'; } else { echo 'Зібрати'; }?></div>
							...
							<div class="island_tree">
								<?if($tree['tree2'] !== '0') {?>
									<form class="island_tree_top island_tree<?=$tree['tree2']?><?if(time() >= $tree['tree2_time'] && time() < $tree['tree2_time'] + 86400) { echo '_ripe'; }?><?if(time() >= $tree['tree2_time'] + 86400) { echo '_rotten'; }?>" action="#" method="POST">
										<div class="tree_timer tree2_timer<?if(time() < $tree['tree2_time']) { echo ' none'; }?><?if(time() >= $tree['tree2_time'] + 86400) { echo ' time_rotten'; }?>"><?if(time() >= $tree['tree2_time'] + 86400) { echo 'Згнило'; } else { echo 'Зібрати'; }?></div>
							...
							<div class="island_tree">
								<?if($tree['tree3'] !== '0') {?>
									<form class="island_tree_bottom island_tree<?=$tree['tree3']?><?if(time() >= $tree['tree3_time'] && time() < $tree['tree3_time'] + 86400) { echo '_ripe'; }?><?if(time() >= $tree['tree3_time'] + 86400) { echo '_rotten'; }?>" action="#" method="POST">
										<div class="tree_timer tree3_timer<?if(time() < $tree['tree3_time']) { echo ' none'; }?><?if(time() >= $tree['tree3_time'] + 86400) { echo ' time_rotten'; }?>"><?if(time() >= $tree['tree3_time'] + 86400) { echo 'Згнило'; } else { echo 'Зібрати'; }?></div>
							...
							<div class="island_tree">
								<?if($tree['tree4'] !== '0') {?>
									<form class="island_tree_bottom island_tree<?=$tree['tree4']?><?if(time() >= $tree['tree4_time'] && time() < $tree['tree4_time'] + 86400) { echo '_ripe'; }?><?if(time() >= $tree['tree4_time'] + 86400) { echo '_rotten'; }?>" action="#" method="POST">
										<div class="tree_timer tree3_timer<?if(time() < $tree['tree4_time']) { echo ' none'; }?><?if(time() >= $tree['tree4_time'] + 86400) { echo ' time_rotten'; }?>"><?if(time() >= $tree['tree4_time'] + 86400) { echo 'Згнило'; } else { echo 'Зібрати'; }?></div>
							...
							<div class="island_tree">
								<?if($tree['tree5'] !== '0') {?>
									<form class="island_tree_bottom island_tree<?=$tree['tree5']?><?if(time() >= $tree['tree5_time'] && time() < $tree['tree5_time'] + 86400) { echo '_ripe'; }?><?if(time() >= $tree['tree5_time'] + 86400) { echo '_rotten'; }?>" action="#" method="POST">
										<div class="tree_timer tree3_timer<?if(time() < $tree['tree5_time']) { echo ' none'; }?><?if(time() >= $tree['tree5_time'] + 86400) { echo ' time_rotten'; }?>"><?if(time() >= $tree['tree5_time'] + 86400) { echo 'Згнило'; } else { echo 'Зібрати'; }?></div>
		...
		<script>
			...
			var countdownfunction = setInterval(function() {
				...
				if (date < 0) {
					...
					document.getElementById("time123").value = "Зібрати";
					document.getElementById("time123").disabled = false;
				}
				if (date + 86400 < 0) {
					clearInterval(countdownfunction);
					document.getElementById("time123").value = "Очистити";
					document.getElementById("time123").disabled = false;
				}
			}, 100);
		</script>
