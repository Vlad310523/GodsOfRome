		...
		<div class="main">
			...
			<div class="battles_main">
				<div class="battles_buttons">
					<div class="battles_button2">Історія</div>
				...
				<div class="battles_block">
					<div class="table_battles battles_history">
						<div class="tr_battles">
							<span class="td_battles">Id битви</span>
							<span class="td_battles">Дата створення</span>
							<span class="td_battles">Вартість</span>
						...
						<div class="tr_battles">
							...
							<span class="td_battles<? if ($row3['winner_id'] == $user_id) { echo ' battles_td_win'; } else { echo ' battles_td_lose'; }?>"><? if ($row3['winner_id'] == $user_id) { echo 'Перемога'; } else if ($row3['enemy_power'] == 0) { echo 'Авто програш'; } else { echo 'Програш'; }?></span>
						</div>
						<? } } else { ?>
						<div class="battles_none">
							У вас немає активних битв
						</div>
						<? } ?>
					</div>
				</div>
