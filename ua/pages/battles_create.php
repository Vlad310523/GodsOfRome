		...
		<div class="main">
			...
			<div class="battles_main">
				<div class="battles_buttons">
					<div class="battles_button2">Створити битву</div>
				...
				<div class="battles_block">
					...
					<form class="form_create_gods" action="../../inc/battles_create.php" method="POST">
						...
						<div class="battles_create_stats">
							Вода > Вогонь > Земля > Блискавка > Вода <span class="tooltip" data-title="Елементи впливають на силу: Бог проти Бога бонус або штраф (10%), як показано на малюнку.">?</span>
						</div>
