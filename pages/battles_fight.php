<?php
	...
	if ($rowdep['sum_gold'] <= 4999) {
		$_SESSION['msgb'] = 'You need to deposit at least 5 dollars to join battle!';
		header('Location: /pages/battles.php');
		exit();
	}
	...
	if ($checks1['status'] != 0) {
		$_SESSION['msgb'] = 'Sorry, the battle has already started!';
		header('Location: /pages/battles.php');
		exit();
	}
		...
		<div class="main">
			<div class="header">
				<div class="panel">
					...
					<a class="panel_exit" href="../inc/logout.php">EXIT</a>
				</div>
				<div class="silver">
			...
			<div class="battles_main">
				<div class="battles_buttons">
					<div class="battles_button3">Create Battle</div>
				</div>
