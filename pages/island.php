<?php
	...
	if (isset($_POST['tutor_ok'])) {
		...
		header('Location: ../pages/island.php');
	}
?>
<!DOCTYPE html>
<html lang="en">
		...
		<div class="main">
			...
			<dialog class="dialog_tutor">
				<div class="tutor_body">
					<div class="tutor_block">
						...
						<div class="block_text">There are a total of five planting beds on your island. You can plant one tree on each of them. So calculate your plantings correctly so that you don't have to get rid of cheap trees later.</div>
					</div>
					<div class="tutor_block">
						<div class="block_text">There are five types of trees of different value and fruitfulness. Each tree has its own harvesting period; if you don't harvest the fruit within 24 hours after ripening, it will rot, and you will have to grow the crop again.</div>
					...
					<div class="tutor_block">
						...
						<div class="block_text">This is your storage area, where all the harvested fruit is stored. There is no limit to the storage capacity.</div>
					</div>
					<div class="tutor_block">
						<div class="block_text">There is also a trader on your island where you can exchange all collected fruits for silver at the rate of 1 fruit for 1 silver.</div>
						<div class="block_picture"><img class="block_img" src="/img/garden/trader.png" alt="trader"></div>
					</div>
					<div class="tutor_block">
						<form action="/pages/island.php" method="POST">
							...
							<div class="itcss__items">
								<div class="itcss__item">
									...
									<div class="dialog_block2">
										<div class="block2"><div class="block2_text">Collection time: </div><div class="block2_amount">3 hours</div></div>
										<div class="block2"><div class="block2_text">Amount of fruits: </div><div class="block2_amount">3</div></div>
									</div>
									<form class="dialog_form" action="/inc/buy_tree.php" method="POST">
										...
										<input class="dialog_yes" type="submit" name="buy" value="Buy">
									</form>
								</div>
								<div class="itcss__item">
									<div class="dialog_block1">
									...
									<div class="dialog_block2">
										<div class="block2"><div class="block2_text">Collection time: </div><div class="block2_amount">6 hours</div></div>
										<div class="block2"><div class="block2_text">Amount of fruits: </div><div class="block2_amount">12</div></div>
									</div>
									<form class="dialog_form" action="/inc/buy_tree.php" method="POST">
								...
								<div class="itcss__item">
									...
									<div class="dialog_block2">
										<div class="block2"><div class="block2_text">Collection time: </div><div class="block2_amount">12 hours</div></div>
										<div class="block2"><div class="block2_text">Amount of fruits: </div><div class="block2_amount">48</div></div>
									</div>
									<form class="dialog_form" action="/inc/buy_tree.php" method="POST">
								...
								<div class="itcss__item">
									...
									<div class="dialog_block2">
										<div class="block2"><div class="block2_text">Collection time: </div><div class="block2_amount">24 hours</div></div>
										<div class="block2"><div class="block2_text">Amount of fruits: </div><div class="block2_amount">240</div></div>
									</div>
									<form class="dialog_form" action="/inc/buy_tree.php" method="POST">
								...
								<div class="itcss__item">
									...
									<div class="dialog_block2">
										<div class="block2"><div class="block2_text">Collection time: </div><div class="block2_amount">48 hours</div></div>
										<div class="block2"><div class="block2_text">Amount of fruits: </div><div class="block2_amount">960</div></div>
									</div>
									<form class="dialog_form" action="/inc/buy_tree.php" method="POST">
			...
			?>
				<dialog class="dialog_sell">
					<h2 class="dialog_sell_h2">Sell tree?</h2>
					<h3 class="dialog_sell_h3">You get: <?=$tree_cost?> silver</h3>
					<form class="dialog_sell_form" action="/inc/collect_tree.php" method="POST">
						<input type="hidden" name="tree_id" value="<?=$tree_id?>">
						<input class="dialog_sell_yes" type="submit" name="sell" value="Yes">
						<input class="dialog_sell_no" type="submit" name="dia_no" value="No" id="closesellwindow">
					</form>
				</dialog>
			<? } ?>
			...
			<dialog class="dialog_tree">
				...
				<div class="dialog_block2">
					<div class="block2"><div class="block2_text">Collection time: </div><div class="block2_amount"><?=$tree_time?></div></div>
					<div class="block2"><div class="block2_text">Amount of fruits: </div><div class="block2_amount"><?=$tree_amount?></div></div>
				</div>
				<div class="dialog_tree_form">
					<form action="" method="POST">
						<input type="hidden" name="tree_id" value="<?=$_SESSION['tree2']?>">
						<input class="dialog_tree_sell" type="submit" name="sell" value="Sell">
					</form>
			...
			<dialog class="dialog_storage none">
				...
				<h2 class="dialog_storage_h2">Storage</h2>
			...
			<dialog class="dialog_trader <?if(!isset($_SESSION['msgitf']) && !isset($_SESSION['msgit'])) { echo 'none'; } ?>">
				...
				<h2 class="dialog_trader_h2">Trader</h2>
				...
				<h3 class="dialog_trader_h3">1 fruit - 1 silver</h3>
				...
				<form class="dialog_trader_form" action="/inc/sell_fruits.php" method="POST">
					<h3 class="dialog_trader_h3">You get - <?=$storage['fruit1']+$storage['fruit2']+$storage['fruit3']+$storage['fruit4']+$storage['fruit5']?> silver</h3>
					<input class="dialog_trader_yes" type="submit" name="sell" value="Sell All">
				</form>
			</dialog>
							...
							<div class="island_tree">
								<?if($tree['tree1'] !== '0') {?>
									<form class="island_tree_top island_tree<?=$tree['tree1']?><?if(time() >= $tree['tree1_time'] && time() < $tree['tree1_time'] + 86400) { echo '_ripe'; }?><?if(time() >= $tree['tree1_time'] + 86400) { echo '_rotten'; }?>" action="#" method="POST">
										<div class="tree_timer tree2_timer<?if(time() < $tree['tree1_time']) { echo ' none'; }?><?if(time() >= $tree['tree1_time'] + 86400) { echo ' time_rotten'; }?>"><?if(time() >= $tree['tree1_time'] + 86400) { echo 'Rotten'; } else { echo 'Collect'; }?></div>
							...
							<div class="island_tree">
								<?if($tree['tree2'] !== '0') {?>
									<form class="island_tree_top island_tree<?=$tree['tree2']?><?if(time() >= $tree['tree2_time'] && time() < $tree['tree2_time'] + 86400) { echo '_ripe'; }?><?if(time() >= $tree['tree2_time'] + 86400) { echo '_rotten'; }?>" action="#" method="POST">
										<div class="tree_timer tree2_timer<?if(time() < $tree['tree2_time']) { echo ' none'; }?><?if(time() >= $tree['tree2_time'] + 86400) { echo ' time_rotten'; }?>"><?if(time() >= $tree['tree2_time'] + 86400) { echo 'Rotten'; } else { echo 'Collect'; }?></div>
							...
							<div class="island_tree">
								<?if($tree['tree3'] !== '0') {?>
									<form class="island_tree_bottom island_tree<?=$tree['tree3']?><?if(time() >= $tree['tree3_time'] && time() < $tree['tree3_time'] + 86400) { echo '_ripe'; }?><?if(time() >= $tree['tree3_time'] + 86400) { echo '_rotten'; }?>" action="#" method="POST">
										<div class="tree_timer tree3_timer<?if(time() < $tree['tree3_time']) { echo ' none'; }?><?if(time() >= $tree['tree3_time'] + 86400) { echo ' time_rotten'; }?>"><?if(time() >= $tree['tree3_time'] + 86400) { echo 'Rotten'; } else { echo 'Collect'; }?></div>
							...
							<div class="island_tree">
								<?if($tree['tree4'] !== '0') {?>
									<form class="island_tree_bottom island_tree<?=$tree['tree4']?><?if(time() >= $tree['tree4_time'] && time() < $tree['tree4_time'] + 86400) { echo '_ripe'; }?><?if(time() >= $tree['tree4_time'] + 86400) { echo '_rotten'; }?>" action="#" method="POST">
										<div class="tree_timer tree3_timer<?if(time() < $tree['tree4_time']) { echo ' none'; }?><?if(time() >= $tree['tree4_time'] + 86400) { echo ' time_rotten'; }?>"><?if(time() >= $tree['tree4_time'] + 86400) { echo 'Rotten'; } else { echo 'Collect'; }?></div>
							...
							<div class="island_tree">
								<?if($tree['tree5'] !== '0') {?>
									<form class="island_tree_bottom island_tree<?=$tree['tree5']?><?if(time() >= $tree['tree5_time'] && time() < $tree['tree5_time'] + 86400) { echo '_ripe'; }?><?if(time() >= $tree['tree5_time'] + 86400) { echo '_rotten'; }?>" action="#" method="POST">
										<div class="tree_timer tree3_timer<?if(time() < $tree['tree5_time']) { echo ' none'; }?><?if(time() >= $tree['tree5_time'] + 86400) { echo ' time_rotten'; }?>"><?if(time() >= $tree['tree5_time'] + 86400) { echo 'Rotten'; } else { echo 'Collect'; }?></div>
			...
			<div class="footer">
				<div class="menu_section">
					<a class="menu_profile" href="/pages/profile.php"></a>
				</div>
				<div class="menu_section">
					<a class="menu_insert" href="/pages/deposit.php"></a>
				</div>
				<div class="menu_section">
					<a class="menu_withdraw" href="/pages/withdraw.php"></a>
				</div>
				<div class="menu_section">
					<a class="menu_help" href="/pages/help.php"></a>
				</div>
			</div>
		</div>
		<script>
			...
			var countdownfunction = setInterval(function() {
				...
				if (date < 0) {
					...
					document.getElementById("time123").value = "Collect";
					document.getElementById("time123").disabled = false;
				}
				if (date + 86400 < 0) {
					clearInterval(countdownfunction);
					document.getElementById("time123").value = "Clear";
					document.getElementById("time123").disabled = false;
				}
			}, 100);
		</script>
