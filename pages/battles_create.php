		...
		<div class="main">
			...
			<div class="battles_main">
				<div class="battles_buttons">
					<div class="battles_button2">Create Battle</div>
					<a class="battles_button" href="/pages/battles.php">Back</a>
				</div>
				<div class="battles_block">
					...
					<form class="form_create_gods" action="/inc/battles_create.php" method="POST">
						<div class="battles_create_gods">
							<div class="battles_create_group1">
								<div class="battles_create_god">
									<div class="battles_create_name">Lightning</div>
								...
								<div class="battles_create_god">
									<div class="battles_create_name">Fire</div>
							...
							<div class="battles_create_group2">
								<div class="battles_create_god">
									<div class="battles_create_name">Earth</div>
								...
								<div class="battles_create_god">
									<div class="battles_create_name">Water</div>
						...
						<div class="battles_create_stats">
							Water > Fire > Earth > Lightning > Water <span class="tooltip" data-title="The elements affect power: God vs God bonus or penalty (10%), as shown.">?</span>
						</div>
						<div class="battles_create_button">
							...
							<input class="battles_create_button_confirm" type="submit" name="confirm_create" value="Confirm">
						</div>
					</form>
				</div>
			</div>
