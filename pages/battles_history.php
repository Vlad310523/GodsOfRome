		...
		<div class="main">
			...
			<div class="battles_main">
				<div class="battles_buttons">
					<div class="battles_button2">History</div>
				...
				<div class="battles_block">
					<div class="table_battles battles_history">
						<div class="tr_battles">
							<span class="td_battles">Battle id</span>
							<span class="td_battles">Date create</span>
							<span class="td_battles">Battle cost</span>
							<span class="td_battles">Your power</span>
							<span class="td_battles">Enemy power</span>
							<span class="td_battles">Result</span>
						</div>
						<?
						...
						<div class="tr_battles">
							...
							<span class="td_battles<? if ($row3['winner_id'] == $user_id) { echo ' battles_td_win'; } else { echo ' battles_td_lose'; }?>"><? if ($row3['winner_id'] == $user_id) { echo 'Win'; } else if ($row3['enemy_power'] == 0) { echo 'Auto Lose'; } else { echo 'Lose'; }?></span>
						</div>
						<? } } else { ?>
						<div class="battles_none">
							You don`t have any battles
						</div>
						<? } ?>
					</div>
				</div>
