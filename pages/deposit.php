	...
	if(isset($_POST['deposit'])){
		...
		if ($_POST['amount'] !== '') {
			if ($amount > 0.99) {
				...
				$_SESSION['msgb'] = 'Amount of $ can\'t be less than 1.00!';
			}
		} else {
			$_SESSION['msgb'] = 'Amount of $ mustn\'t be empty';
		}
	}
?>
		...
		<div class="main">
			...
			<div class="help_main">
				<div class="help_buttons">
					<div class="help_button3">Deposit</div>
				...
				<div class="help_block">
					<div class="block1">
						<div class="swap_block">
							...
							<h1 class="h1_block">Deposit silver</h1>
							<h2 class="h2_block">1 dollar $ - 1000 silver <img src="../img/islands/coin_silver.png" alt="coin"></h2>
							<h2 class="h2_block">
								<label class="method">
							...
							<h2 class="h2_block">
								<form class="swap_form" action="" method="POST">
									<label for="deposit_text">Amount $:</label>
									<input class="swap_text" type="text" name="deposit_amount" id="deposit_text">
									<input class="withdraw_input" name="deposit" type="submit" value="deposit">
								</form>
							</h2>
						</div>
						<h1 class="h2_block">Last 20 deposits</h1>
						<div class="table_profile">
							...
							<div class="tr_profile">
								...
								<span class="td_profile"><?if ($row4['status'] == 1) { echo 'Success'; } else { echo 'Failed'; }?></span>
							</div>
							<? } } else { ?>
							<div class="swap_none">
