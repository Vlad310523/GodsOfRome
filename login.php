				...
				<div class="block-reg">
					...
					<div class="block-reg-container">
						<div class="form-reg">
							<div class="reg">
								<h1 class="h-reg">
									<a href="/register.php" class="but1 blur">Register</a> | 
									<a href="#" class="but1" style="cursor: default;">Login</a>
								</h1>
								<?if(isset($_SESSION['msg'])){?>
									<h1 class="msg-f"><?=$_SESSION['msg']?></h1>
								<?} unset($_SESSION['msg']);?>
								<?if(isset($_SESSION['msg-s'])){?>
									<h1 class="msg-f msg-t"><?=$_SESSION['msg-s']?></h1>
								<?} unset($_SESSION['msg-s']);?>
								<form class="form-main" action="inc/login.php" method="POST">
									...
									<a class="form-text-forgot" href="/forgot.php">Forgot password?</a>
